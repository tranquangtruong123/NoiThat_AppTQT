...
public class QLySanPham extends AppCompatActivity {
    private ImageView img_back,img_anh_dl,img_camera,img_fodel;
    private EditText edt_gia,edt_mota,edt_kt,edt_thongtin,edt_uudai,edt_cl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        anhxa();
        img_back.setOnClickListener(view -> startActivity(new Intent(QLySanPham.this,QLAdmin.class)));
        img_camera.setOnClickListener(view -> {
            Intent maychup = new Intent(ACTION_IMAGE_CAPTURE);
            if(ActivityCompat.checkSelfPermission(QLySanPham.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(QLySanPham.this,new String[]{Manifest.permission.CAMERA},1);
                return;
            }
        ...
        bntht.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(QLySanPham.this, MainActivity.class);
        ...
        bnt_luu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    createDatabase.addItemsp(ImageView_To2(img_anh_dl),edt_mota.getText().toString(),Double.parseDouble(edt_gia.getText().toString())
                            ,edt_uudai.getText().toString(),edt_thongtin.getText().toString(),s);
                    Toast.makeText(QLySanPham.this, "Thành Công", Toast.LENGTH_SHORT).show();
                }catch (Exception e){
                    Toast.makeText(QLySanPham.this, "Kết Nối Thất Bại", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    private void anhxa() {
        img_back = findViewById(R.id.sp_back);
        img_anh_dl = findViewById(R.id.sp_img);
        img_camera = findViewById(R.id.sp_camera);
        img_fodel = findViewById(R.id.sp_fodel);
        edt_gia = findViewById(R.id.sp_edt_price);
        edt_mota = findViewById(R.id.sp_edt_mota);
        edt_kt = findViewById(R.id.sp_edt_kichthuoc);
        edt_thongtin = findViewById(R.id.sp_edt_thongtin);
        edt_uudai = findViewById(R.id.sp_edt_sale);
        edt_cl = findViewById(R.id.sp_edt_chatlieu);
        bnt_luu = findViewById(R.id.sp_bnt_save);
        bntht = findViewById(R.id.sp_bnt_hienthi);
    }
    @Override
